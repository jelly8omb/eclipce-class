...
<body>
	<div class="contents-wrap">
		...
		<form action="productReg.cc" method="post">
			<ul class="join-wrap">
				<li>상품코드</li>
				<li><input name="pcode" type="text"
					placeholder="상품코드를 입력해 주세요." /></li>

				<li>카테고리</li>
				<li><input name="category" type="text" placeholder="카테고리" /></li>
				<li>상품이름</li>
				<li><input name="pname" type="text" placeholder="상품이름을 입력해 주세요." /></li>
				<li>가격</li>
				<li id="priceChk"><input name="price" type="text"
					placeholder="가격" /></li>
			</ul>
