...
<body>
	...
	<fmt:formatNumber value="789789.12345" pattern="#,###.#####" />
	<br>
	<fmt:formatNumber value="789789.123" pattern="0,000,000,000.00000" />
	<br>
	<!-- fmt:formatXXXX : 출력과 변수에 저장, fmt:parseXXXX : 변수에 저장 -->
	<hr>
	<!-- 화폐, 날짜는 locale에 따라 출력이 다름 -->
	<!-- 날짜 패턴에 대소문자 유의 : 일 dd, 월 MM , 분 mm , 시(12) hh , 시(24) HH -->
	<!-- now 에트리뷰트 값 : 여기서는 테스트 위해서 자바 객체로 생성합니다. -->
	...
	지정된 시간과 날짜 :
	<c:out value="${datetime1 }" />
	<br>
	<!-- 출력결과 : Thu Nov 03 20:14:00 KST 2022 -->
