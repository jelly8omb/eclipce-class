...
<body>
	...
	<div class="search">
		...
		<form class="form">
			...
			</select> <input type="text" name="keyword" placeholder="상품명 검색어 입력하세요." value="${keyword }">
			<span style="padding-left: 10px;">가격대별</span> <input type="text"
				name="from" placeholder="10000"> <b>~</b> <input type="text"
				name="to" placeholder="50000">
			<button id="search" type="button">조회</button>
			<button id="selectAll" type="button"
				onclick="location.href='search.cc'">전체보기</button>
		</form>
	</div>
	<hr>
	<ul>
