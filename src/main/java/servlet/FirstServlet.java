...
public class FirstServlet extends HttpServlet{
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      LOGGER.info("\n[MyInfo] : request URL : {}, URI : {}, 켄택스트패스 : {} ", req.getRequestURL(), req.getRequestURI(), req.getContextPath());
      
      //텍스트 :  서블릿에서 html 출력 응답도 만들어 봅니다.
      // out 은 jsp의 내장객체(선언없이 사용), 서블릿은 직접 생성
      resp.setContentType("text/html; charset=UTF-8");
      PrintWriter out = resp.getWriter();	//resp 객체의 출력스트림 생성
      out.print("<html>");
